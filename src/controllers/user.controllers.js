...
const changeCurrentPassword =asyncHandler(async(req,res)=>{
   ...
   const isPasswordCorrect=await user.isPasswordCorrect(oldPassword) // since we used async while declaring this method in user.models.js this means it will take some time therefore need to use async here
